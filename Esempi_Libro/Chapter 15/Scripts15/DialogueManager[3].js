...
replies_1[7] = "0001 1 0100^Try using this rock^The rock doesn't work?^Sorry, you're on your own now";
replies_1[8] = "9000 0 0000  Good luck with that";
...
topics_2[0] = "000 null"; 
topics_2[1] = "100 Hi"; 
topics_2[2] = "100 What happened to the other guy?";
topics_2[3] = "100 I got the topi fruit, what am I supposed to do with it?";
topics_2[4] = "000 Where do I find the Tree of Life?";
topics_2[5] = "000 How do I find the tunnels?";
topics_2[6] = "000 Can you be more specific?";
topics_2[7] = "100 I keep blacking out in the tunnels, could you help me out with a light source?";
topics_2[8] = "100 The maze looks different, how do I get out of it?";
topics_2[9] = "100 See you around";
topics_2[10] = "100 Thanks for your help";

// replies_2 character reply text
internal var replies_2 = new String[11];
replies_2[0] = "0000 0 0000 You shouldn't see this"; 
replies_2[1] = "0000 0 0000 Greetings, adventurer";
replies_2[2] = "0000 0 0000 Oh, he's probably still stuck in the maze";
replies_2[3] = "2040 1 0000 You must replace the dying Tree of Life by planting the new fruit";
replies_2[4] = "2050 1 0000 You will find a way to it in the tunnels";
replies_2[5] = "2060 1 0000 The tunnels are in the rock dome, there used to be a map of them in the temple";
replies_2[6] = "0001 1 0200^I have marked a trail to the top for you and cleared the entrance^There's nothing more I can do for you";
replies_2[7] = "0000 0 0000 The flower of a local, but rare plant is said to be quite illuminating";
replies_2[8] = "0009 0 0000^Trial and error^I cannot help you with that^It is ever changing, there is no map^No idea, I've been stuck here for ages";
replies_2[9] = "9009 0 0000^I wish you success^Come back any time^Good luck^May your quest bear fruit";
replies_2[10] = "0000 0 0000 Any time";
...
SetNPC(2); // set the current NPC's ID number by calling the SetNPC function
