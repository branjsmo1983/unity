...
function OnGUI () {
  ...
  // control elements
   ...
   var buttnRectTemp : Rect = Rect (groupWidth/2 - buttnRect .width/2 ,40,buttnRect .width,buttnRect .height);
...
function LoadSavedGame (fileName : String) {
	...
	if(!sRead) return; //if there was no file, return
