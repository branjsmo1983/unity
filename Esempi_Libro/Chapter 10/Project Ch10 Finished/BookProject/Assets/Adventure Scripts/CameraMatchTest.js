#pragma strict
var targetPos : Transform ; // destination position
internal var source : Transform ; // the position of the object the script is on, start pos
var duration : float = 1.0 ; // seconds duration of the camera match
var targetLook : Transform; // camera's target for lookAt
